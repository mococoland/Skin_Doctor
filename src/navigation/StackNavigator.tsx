...
const StackNavigator: React.FC = () => {
  ...
  return (
    <Stack.Navigator
      initialRouteName="HomeScreen" // 홈스크린으로 변경
      screenOptions={{
        headerStyle: {
    ...
    >
      ...
      {/* 공통 화면 */}
      <Stack.Screen name="HomeScreen" component={HomeScreen} options={{ title: "홈" }} />

      {/* 인증 관련 화면 */}
      <Stack.Screen name="LoginScreen" component={LoginScreen} options={{ title: "로그인" }} />
      <Stack.Screen name="DoctorRegister" component={RegisterScreen} options={{ title: "회원가입" }} />
      <Stack.Screen name="FindIdScreen" component={FindIdScreen} options={{ title: "아이디 찾기" }} />
      <Stack.Screen name="DoctorFindPassword" component={FindPasswordScreen} options={{ title: "비밀번호 찾기" }} />

      {/* 메인 앱 화면 */}
      <Stack.Screen name="DashboardScreen" component={DashboardScreen} options={{ title: "대시보드" }} />
      ...
      />
      <Stack.Screen name="DoctorProfile" component={DoctorProfileScreen} options={{ title: "프로필 설정" }} />
